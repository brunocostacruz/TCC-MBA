...
const routes: Routes = [
  ...
  { path: 'scheduling-awaiting-approval', loadChildren: () => import('./scheduling-awaiting-approval/scheduling-awaiting-approval.module').then(m => m.SchedulingAwaitingApprovalPageModule) },
];
